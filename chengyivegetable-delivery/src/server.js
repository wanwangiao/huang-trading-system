...
// 為 Vercel 設定預設環境變數（如果沒有設定）
if (!process.env.DATABASE_URL) {
  process.env.DATABASE_URL = 'postgresql://postgres.cywcuzgbuqmxjxwyrrsp:Chengyi2025%21Fresh@aws-1-ap-southeast-1.pooler.supabase.com:6543/postgres';
}
if (!process.env.NODE_ENV) {
  process.env.NODE_ENV = 'production';
}
if (!process.env.LINE_CHANNEL_ID) {
  process.env.LINE_CHANNEL_ID = '2007891772';
}
if (!process.env.LINE_CHANNEL_SECRET) {
  process.env.LINE_CHANNEL_SECRET = '35bc80bb75f95d22a49aaaf8772eef38';
}
if (!process.env.LINE_CHANNEL_ACCESS_TOKEN) {
  process.env.LINE_CHANNEL_ACCESS_TOKEN = 'Rb4HdoTx3gV7skydMOJy4/0xw09IpOc9djST7z5eSEs+CccUAfsdtrPlI3SEEQya+Npz6+OW6B8un+Tfr6sJ6dw3Aab1Y+kLng21ZAXjO0sYYS7ILLzH4ccNVRDh8Xnv3ch0DTDNGT8pc+7bGZjruAdB04t89/1O/w1cDnyilFU=';
}
if (!process.env.LINE_LIFF_ID) {
  process.env.LINE_LIFF_ID = '2007966099-qXjNxbXN';
}
if (!process.env.GOOGLE_MAPS_API_KEY) {
  process.env.GOOGLE_MAPS_API_KEY = 'AIzaSyBRwW-NMUDGMXaDhvl3oYJs_OqjfXWTTNE';
}
